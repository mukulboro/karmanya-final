...
const Mission = ({ data }) => {
    ...
    <p className={styles.description}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima quam dicta omnis? Atque enim vero labore itaque laudantium, eum voluptates vitae nihil sapiente facilis nostrum saepe amet. Ducimus dolorum iste, distinctio, pariatur quibusdam, eum necessitatibus aut similique nesciunt nulla maiores.</p>
...
const WorkList = ({ works })=>{
    return <section className={styles.work}>
        {
            works.map((work)=>{
                return <section key={work.id} className={styles.workBody}>
